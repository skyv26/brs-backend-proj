...
class User < ApplicationRecord
  ...
  def validate_full_name
    unless full_name_before_type_cast.is_a?(String)
      errors.add(:full_name, 'must be a string')
    end
  ...
  def validate_email_address
    unless email_address_before_type_cast.is_a?(String)
      errors.add(:email_address, 'must be a string')
    end
  ...
  def validate_date_of_birth
    unless date_of_birth_before_type_cast.is_a?(String)
